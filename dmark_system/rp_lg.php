...
<thead>
  ...
  <tr>
    <td width="7%"><strong><center>Lugares</center></strong></td>
  </tr>
</thead>
<tbody>
<?php 
	$mensaje='no';
    $can=mysqli_query($con,"select * from lugares");	
    while($dato=mysqli_fetch_array($can)){
		$cant=$dato['nombre_lugar'];
		if($cant=!0){
			$mensaje='si';
?>
  <tr>
      <td><div align="right"><center><?php echo $dato['nombre_lugar']; ?></center></div></td>
