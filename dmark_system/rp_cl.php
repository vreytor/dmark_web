...
<thead>
  ...
  <tr>
  <td width="7%"><strong><center>DNI</center></strong></td>
...
<?php 
	$mensaje='no';
    $can=mysqli_query($con,"select * from clientes");
    while($dato=mysqli_fetch_array($can)){
		$cant=$dato['nombre_cliente'];
		if($cant=!0){
			$mensaje='si';
?>
  <tr>
		<td><div align="right"><center><?php echo $dato['dni_cliente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['nombre_cliente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['telefono_cliente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['email_cliente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['direccion_cliente']; ?></center></div></td>
