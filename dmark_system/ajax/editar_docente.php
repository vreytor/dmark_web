<?php
	...
	if (empty($_POST['mod_id'])) {
           ...
           $errors[] = "Nombre vacío";
			...
			$errors[] = "Selecciona el estado del Instructor";
		}  else if (
			!empty($_POST['mod_id']) &&
		...
		$id_docente=intval($_POST['mod_id']);
		$sql="UPDATE docentes SET dni_docente='".$dni."',nombre_docente='".$nombre."', telefono_docente='".$telefono."', email_docente='".$email."', direccion_docente='".$direccion."', status_docente='".$estado."' WHERE id_docente='".$id_docente."'";
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				$messages[] = "Instructor ha sido actualizado satisfactoriamente.";
			} else{
				$errors []= "Este Instructor ya esta registrado.";
			}
		} else {
