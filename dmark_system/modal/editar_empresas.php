	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Editar Empresa</h4>
		  </div>
		  <div class="modal-body">
			<form class="form-horizontal" method="post" id="editar_empresa" name="editar_empresa">
			<div id="resultados_ajax2"></div>
			 <div class="form-group">
				<label for="mod_dni" class="col-sm-3 control-label">RUC</label>
				<div class="col-sm-8">
