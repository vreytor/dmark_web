...
<?php 
	$mensaje='no';
    $can=mysqli_query($con,"select * from docentes");
    while($dato=mysqli_fetch_array($can)){
		$cant=$dato['nombre_docente'];
		if($cant=!0){
			$mensaje='si';
?>
  <tr>
		<td><div align="right"><center><?php echo $dato['dni_docente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['nombre_docente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['telefono_docente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['email_docente']; ?></center></div></td>
		<td><div align="right"><center><?php echo $dato['direccion_docente']; ?></center></div></td>
